...
!function (a) {
    ...
    a.fn.editor = function (c) {
        ...
        return void 0 == a(this[0]).attr("id") ? a(this[0]).attr("id", d) : d = this.get(0).id, this.getHtml = function () {
        ...
        }, e = this.editorPath(), this.loadCss(e), f = navigator.userAgent.toLowerCase(), g = f.match(/(iPhone|Android|mobile)/i) ? !0 : !1, h = !(f.indexOf("applewebkit") > -1 || f.indexOf("firefox") > -1), k = {
            a: "link",
            td: "table",
            pre: "pre",
            p: "p",
            ...
            audio: "music",
            video: "video"
        }, m = ["宋体", "微软雅黑", "楷体", "黑体", "隶书", "Pingfang SC", "arial", "arial black", "verdana", "impact"], n = ["12", "13", "14", "15", "16", "18", "20", "22", "24", "26", "28", "30", "36"], o = [{
            t: "左对齐",
            c: "justifyleft"
        }, {t: "居中", c: "justifycenter"}, {t: "右对齐", c: "justifyright"}, {
            t: "两端对齐",
            c: "justifyfull"
        }], p = [{t: "项目列表", c: "InsertUnorderedList"}, {
            t: "数字列表",
            c: "InsertOrderedList"
            ...
            c: "p",
            s: 16
        }, {t: "标题1", c: "h1", s: 28}, {t: "标题2", c: "h2", s: 24}, {t: "标题3", c: "h3", s: 20}, {
            t: "引用",
            c: "pre",
            s: 16
        }], t = {
            key: "_editor_page_",
            html: '<hr class="ui_editor_pagebreak" noshade="noshade" contentEditable="false">'
        }, u = ["meta", "script", "object", "form"], v = "V1.1.1", w = {
            toolbar: "full",
            mode: "html",
            height: 300,
            value: "",
            ...
            if (b++, c = this, c.cmd = c.bookmark = c.actname = c.parent = c.timer = c.table = "", c.isfullscreen = c.isPop = c.isDrag = !1, c.source = a(c), c.values = x.value, c.hide = x.hide, c.mode = x.mode, c.height = x.height, c.upload = x.upload, c.file = x.file, c.saveurl = x.save, c.autoupload = x.auto, c.params = x.params, c.autosave = x.autosave, c.headline = x.headline, c.toolbar = x.toolbar, c.fontfamily = x.fontfamily, c.fontsize = x.fontsize, c.color = x.color, c.bgcolor = x.bgcolor, c.arrow = x.arrow, c.pagebreak = t, c.plug = x.plug, c.autofocus = x.autofocus, c.fileList = [], c.filekey = [], a(c).css("display", "none"), f = a(c).attr("name") || a(c).attr("class") || d, c.isTextarea = !0, "textarea" != a(c)[0].tagName.toLowerCase() && (w = a('<textarea name="' + f + '"" style="display:none;border:0;height:0;"></textarea>'), a(c).after(w), c.source = w, c.isTextarea = !1), c.toolbars = {
                ...
                admin: {
                    left: ["headline", "fontfamily", "fontsize", "fontcolor", "bgcolor", "|", "bold", "italic", "underline", "strikethrough", "|", "list", "align", "indent", "outdent", "|", "subscript", "superscript", "link", "unlink", "|", "emoji", "table", "image", "upload", "down", "line", "pagebreak", "auto"],
                    right: ["html", "fullscreen", "about"]
                },
                mini: {
                    left: ["headline", "fontcolor", "bold", "italic", "underline", "strikethrough", "list", "align", "|", "link", "unlink", "image", "emoji"],
                    right: ["html", "fullscreen", "about"]
                }
                ...
                bold: {name: "加粗 Ctrl+B"},
                italic: {name: "斜体 Ctrl+I"},
                underline: {name: "下划线 Ctrl+U"},
                ...
                InsertUnorderedList: {name: "项目列表"},
                InsertOrderedList: {name: "数字列表"},
                indent: {name: "增加缩进"},
                outdent: {name: "减少缩进"},
                align: {
                ...
                justifyleft: {name: "左对齐"},
                justifycenter: {name: "居中"},
                justifyright: {name: "右对齐"},
                justifyfull: {name: "两端对齐"},
                subscript: {name: "下标"},
                superscript: {name: "上标"},
                link: {
                    name: "链接", dialog: function () {
                        var b, d, e, f, g;
                        for (a(".ui-dialog").remove(), b = url = title = target = "", d = c.getParent("a"), e = "添加链接", d.length > 0 && (b = d.html() || "", url = d.attr("href") || "", title = d.attr("title") || "", target = d.attr("target") || "", e = "编辑链接"), "" == b && (b = c.getSel(), target = " checked"), target = "" != target ? "checked" : "", f = [{
                            n: "文本",
                            e: "text",
                            v: b
                        }, {n: "链接", e: "url", v: url}, {
                        ...
                        c.dialog({
                            title: e, text: g, width: "400px", ok: function (b) {
                                var e = a("#editor_link_text").val(), f = a("#editor_link_url").val(),
                                    g = a("#editor_link_title").val(), h = a("#editor_link_new").is(":checked"),
                                    i = h ? "_blank" : "";
                                return "" == e ? (c.msg({
                                    id: "#editor_link_text",
                                    msg: "文本不能为空"
                                }), void 0) : c.input(e) ? (c.msg({
                                    id: "#editor_link_text",
                                    msg: "文本设置错误"
                                }), void 0) : "" != f && c.input(f) ? (c.msg({
                                    id: "#editor_link_url",
                                    msg: "网址设置错误"
                                }), void 0) : "" != g && c.input(g, "text") ? (c.msg({
                ...
                music: {
                    name: "音乐", dialog: function () {
                        ...
                        for (a(".ui-dialog").remove(), b = autoplay = "", d = c.parent, e = c.isSdcms("audio", d), f = "添加音乐", d.length > 0 && e && (b = d.attr("src") || "", autoplay = d.attr("autoplay") || "", f = "编辑音乐"), "" == b && (autoplay = "autoplay"), g = "", g += '<div class="ui-editor-form-group">', g += '    <div class="ui-editor-input-group">', g += '        <span class="ui-editor-before">网址</span>', g += '        <input type="text" id="editor_music_url" class="ui-editor-form-ip ui-editor-radius' + ("" == c.upload ? "-left" : "") + '-none" value="' + b + '">', "" != c.upload && (g += '        <span class="ui-editor-after" id="ui_editor_file_upload">上传</span>'), g += "    </div>", g += "</div>", g += '<div class="ui-editor-form-group">', g += '    <div class="ui-editor-input-group">', g += '        <span class="ui-editor-before">播放</span>', g += '        <select id="editor_music_auto" class="ui-editor-form-ip ui-editor-radius-left-none">', h = [{
                            ...
                            t: "手动播放",
                            v: ""
                        }], i = 0; i < h.length; i++) g += '        <option value="' + h[i].v + '" ' + (autoplay == h[i].v ? " selected" : "") + ">" + h[i].t + "</option>";
                        g += "        </select>", g += "    </div>", g += "</div>", c.dialog({
                            ...
                            ok: function (b) {
                                ...
                                return "" == f ? (c.msg({
                                    id: "#editor_music_url",
                                    msg: "网址不能为空"
                                }), void 0) : c.input(f) ? (c.msg({
                                    id: "#editor_music_url",
                                    msg: "网址设置错误"
                                }), void 0) : "" != g && c.input(g, "en") ? (c.msg({
                ...
                video: {
                    name: "视频", dialog: function () {
                        ...
                        g += "        </select>", g += "    </div>", g += "</div>", g += '<div class="ui-editor-form-group">', g += '    <div class="ui-editor-input-group">', g += '        <span class="ui-editor-before">宽度</span><input type="text" id="editor_video_width" class="ui-editor-form-ip ui-editor-radius-left-none ui-editor-mr" maxlength="5" value="' + width + '">', g += '        <span class="ui-editor-before ui-editor-ml">高度</span><input type="text" id="editor_video_height" class="ui-editor-form-ip ui-editor-radius-left-none" maxlength="5" value="' + height + '">', g += "    </div>", g += "</div>", c.dialog({
                            ...
                            width: "400px",
                            ok: function (b) {
                                var f = a("#editor_video_url").val(), g = a("#editor_video_auto").val(),
                                    h = a("#editor_video_width").val(), i = a("#editor_video_height").val();
                                return "" == f ? (c.msg({
                                    id: "#editor_video_url",
                                    msg: "网址不能为空"
                                }), void 0) : c.input(f) ? (c.msg({
                                    ...
                                    id: "#editor_video_auto",
                                    msg: "播放设置错误"
                                }), void 0) : "" != h && c.input(h, "int") ? (c.msg({
                                    id: "#editor_video_width",
                                    msg: "宽度设置错误"
                                }), void 0) : "" != i && c.input(i, "int") ? (c.msg({
                ...
                table: {
                    name: "表格", html: function () {
                        ...
                        var b = c.editor.find(".ui-editor-table"), d = c.editor.find(".ui-editor-table-on"),
                            e = c.editor.find(".ui-editor-table-num");
                        a(b).hover(function () {
                            var g = 0, h = 0;
                            a(this).mousemove(function (c) {
                                var f = c.clientX - b.offset().left - 5,
                                    i = c.clientY - b.offset().top + a(window).scrollTop() - 5;
                                180 >= f && 180 >= i && (g = Math.ceil(f / 18), h = Math.ceil(i / 18), a(d).css({
                                    width: 18 * g + "px",
                                    height: 18 * h + "px"
                                }), a(e).html(g + " × " + h))
                ...
                emoji: {
                    name: "表情", html: function () {
                        var c, d, a = '<div class="ui-editor-emoji">',
                            b = [[128512, 128591], [129296, 129342], [127792, 127879], [128112, 128175], [129412, 129412]];
                ...
                image: {
                    name: "图像", dialog: function () {
                        var b, d, e, f, g, h;
                        for (a(".ui-dialog").remove(), b = alt = width = height = align = hspace = vspace = "", d = c.parent, e = c.isSdcms("img", d), f = "插入图像", d.length > 0 && e && (b = d.attr("src") || "", alt = d.attr("alt") || "", width = d.attr("width") || "", height = d.attr("height") || "", align = d.attr("align") || "", hspace = d.attr("hspace") || "", vspace = d.attr("vspace") || "", f = "编辑图像"), g = [{
                            t: "默认",
                            v: ""
                        }, {t: "左对齐", v: "left"}, {t: "居中", v: "center"}, {
                            t: "右对齐",
                            v: "right"
                        ...
                        h += "        </select>", h += "    </div>", h += "</div>", h += '<div class="ui-editor-form-group">', h += '    <div class="ui-editor-input-group">', h += '        <span class="ui-editor-before">描述</span>', h += '        <input type="text" id="editor_image_alt" class="ui-editor-form-ip ui-editor-radius-left-none" value="' + alt + '">', h += "    </div>", h += "</div>", h += '<div class="ui-editor-form-group editor_image_text">', h += '    <div class="ui-editor-text-center">', h += '        <a href="javascript:;" class="editor_image_hide ui-editor-text-gray">其他参数<span class="ui_editor_arrow"></span></a>', h += "    </div>", h += "</div>", h += '<div class="ui-editor-form-group editor_image_other ui-editor-hide">', h += '    <div class="ui-editor-input-group">', h += '        <span class="ui-editor-before">宽度</span><input type="text" id="editor_image_width" class="ui-editor-form-ip ui-editor-radius-left-none ui-editor-mr" maxlength="5" value="' + width + '">', h += '        <span class="ui-editor-before ui-editor-ml">高度</span><input type="text" id="editor_image_height" class="ui-editor-form-ip ui-editor-radius-left-none" maxlength="5" value="' + height + '">', h += "    </div>", h += "</div>", h += '<div class="ui-editor-form-group editor_image_other ui-editor-hide">', h += '    <div class="ui-editor-input-group">', h += '        <span class="ui-editor-before">水平间距</span><input type="text" id="editor_image_hspace" class="ui-editor-form-ip ui-editor-radius-left-none ui-editor-mr" maxlength="4" value="' + hspace + '">', h += '        <span class="ui-editor-before ui-editor-ml">垂直间距</span><input type="text" id="editor_image_vspace" class="ui-editor-form-ip ui-editor-radius-left-none" maxlength="4" value="' + vspace + '">', h += "    </div>", h += "</div>", c.dialog({
                            title: f, text: h, width: "400px", ok: function (b) {
                                var f = a("#editor_image_src").val(), g = a("#editor_image_alt").val(),
                                    h = a("#editor_image_width").val(), i = a("#editor_image_height").val(),
                                    j = a("#editor_image_align").val(), k = a("#editor_image_hspace").val(),
                                    l = a("#editor_image_vspace").val();
                                return "" == f ? (c.msg({
                                    id: "#editor_image_src",
                                    msg: "图像不能为空"
                                }), void 0) : c.input(f) ? (c.msg({
                                    ...
                                    id: "#editor_image_width",
                                    msg: "宽度设置错误"
                                }), void 0) : "" != i && c.input(i, "int") ? (c.msg({
                                    id: "#editor_image_height",
                                    msg: "高度设置错误"
                                }), void 0) : "" != j && c.input(j, "en") ? (c.msg({
                                    id: "#editor_image_align",
                                    msg: "对齐设置错误"
                                }), void 0) : "" != k && c.input(k, "int") ? (c.msg({
                                    id: "#editor_image_hspace",
                                    msg: "水平间距设置错误"
                                }), void 0) : "" != l && c.input(l, "int") ? (c.msg({
                ...
                upload: {
                    name: "附件上传", dialog: function () {
                        ...
                        b += '<div class="ui-editor-upload-multiple">', b += '    <div class="ui-editor-upload-btn ui-editor-btn">选择文件<input type="file" multiple class="ui-editor-upload-choose"></div>', b += '    <div class="ui-editor-upload-btn ui-editor-btn ui-editor-btn-blue ui-editor-ml ui-editor-upload-begin">开始上传</div>', b += '    <div class="ui-editor-upload-body">', b += '        <div class="ui-editor-upload-drop"><i class="ui-editor-icon-upload"></i>请将文件拖到此处</div>', b += '        <div class="ui-editor-upload-list ui-editor-hide">', b += '            <table width="100%">', b += "                <thead>", b += "                <tr>", b += '                    <th>文件</th><th width="120">大小</th><th width="80">状态</th><th width="60">操作</th>', b += "                </tr>", b += "               </thead>", b += '                <tbody class="ui-editor-upload-tbody">', b += "                </tbody>", b += "            </table>", b += "        </div>", b += "    </div>", b += "</div>", c.dialog({
                            ...
                            ok: function (b) {
                                ...
                                return e > 0 ? (f = 0, d.find("tr").each(function () {
                                    var d = a(this).attr("data-url"), e = a(this).attr("data-state"),
                                        g = a(this).attr("data-type"), h = a(this).children().eq(0).html(),
                                        i = '<p><a href="' + d + '" target="_blank" title="' + h + '">' + h + "</a></p>";
                                    if (3 == e && "" != d) {
                                        switch (f = 1, g) {
                                            case"img":
                                                i = '<img src="' + d + '" alt="' + h + '">';
                                    ...
                                    id: ".ui-editor-upload-begin",
                                    msg: "请先上传",
                                    time: 3
                                }), void 0) : (b.close(), void 0)) : (c.msg({
                                    id: ".ui-editor-upload-choose",
                                    msg: "请选择文件",
                                    time: 3
                                }), void 0)
                            }
                        ...
                        var b = a(".ui-editor-upload-drop"), e = a(".ui-editor-upload-choose"),
                            f = a(".ui-editor-upload-begin"), g = a(".ui-editor-upload-list"),
                            h = a(".ui-editor-upload-tbody"), j = function (a) {
                                var c, b = ["Bytes", "KB", "MB"];
                                ...
                                for (i = 0; i < a.length; i++) b = a[i], d = b.name, e = b.size, f = d + e, g = k(b.type, d), -1 == c.filekey.indexOf(f) ? (h = [b, l(d), e, 1, "准备", "", "", g], n(h), c.fileList.push(h), c.filekey.push(f)) : c.msg({
                                    id: ".ui-editor-upload-choose",
                                    msg: "重复添加",
                                    time: 3
                                });
                                ...
                                var b = '<tr data-state="' + a[3] + '" data-url="' + a[6] + '" data-type="' + a[7] + '">',
                                    c = 2 == a[3] ? '<span class="ui-editor-tips" data-that="' + d + '" data-title="' + a[5] + '">' + a[4] + "</span>" : a[4];
                                b += "    <td>" + a[1] + "</td><td>" + j(a[2]) + "</td><td>" + c + '</td><td><a href="javascript:;">删除</a></td>', b += "</tr>", h.append(b)
                            }, o = function () {
                                var e, f, g, b = 0, d = h.find("tr");
                                for (e = 0; e < d.length; e++) f = d.eq(e), g = a(f).attr("data-state"), 1 == g && (b++, c.AjaxUpMore({
                                    index: e,
                                    source: f
                                }));
                ...
                auto: {
                    name: "自动排版", html: function () {
                        var c, a = [{
                            ...
                            d: 1,
                            c: 1,
                            s: [{n: "清除空行", e: "cleanEmptyline", t: "checkbox", v: "", c: 0}, {
                                n: "清除无用代码",
                                e: "cleanUselessCode",
                                t: "checkbox",
                                v: "",
                                c: 1
                            }, {n: "清除CSS", e: "cleanClass", t: "checkbox", v: "", c: 0}]
                        }, {
                            n: "符号转换",
                            e: "charSwitch",
                            d: 0,
                            c: 1,
                            s: [{n: "全角转半角", e: "charSwitchValue", t: "radio", v: "tohalf", c: 1}, {
                                n: "半角转全角",
                                e: "charSwitchValue",
                                t: "radio",
                                v: "tofull",
                            ...
                            d: 0,
                            c: 1,
                            s: [{n: "空格缩进", e: "indentValue", t: "radio", v: "space", c: 1}, {
                                n: "样式缩进",
                                e: "indentValue",
                                t: "radio",
                                v: "css",
                                c: 0
                            }, {n: "清除缩进", e: "indentValue", t: "radio", v: "none", c: 0}]
                        }, {
                            n: "段落对齐",
                            e: "textAlign",
                            d: 0,
                            c: 0,
                            s: [{n: "默认", e: "textAlignValue", t: "radio", v: "none", c: 1}, {
                                n: "左对齐",
                                e: "textAlignValue",
                                t: "radio",
                                v: "left",
                                c: 0
                            }, {n: "居中", e: "textAlignValue", t: "radio", v: "center", c: 0}, {
                                n: "右对齐",
                                e: "textAlignValue",
                                t: "radio",
                                v: "right",
                            ...
                            d: 0,
                            c: 0,
                            s: [{n: "默认", e: "tableAlignValue", t: "radio", v: "none", c: 1}, {
                                n: "左对齐",
                                e: "tableAlignValue",
                                t: "radio",
                                v: "left",
                                c: 0
                            }, {n: "居中", e: "tableAlignValue", t: "radio", v: "center", c: 0}, {
                                n: "右对齐",
                                e: "tableAlignValue",
                                t: "radio",
                                v: "right",
                            ...
                            d: 0,
                            c: 0,
                            s: [{n: "默认", e: "imageAlignValue", t: "radio", v: "none", c: 1}, {
                                n: "左对齐",
                                e: "imageAlignValue",
                                t: "radio",
                                v: "left",
                                c: 0
                            }, {n: "居中", e: "imageAlignValue", t: "radio", v: "center", c: 0}, {
                                n: "右对齐",
                                e: "imageAlignValue",
                                t: "radio",
                                v: "right",
                ...
                code: {
                    name: "代码", html: function () {
                        var d,
                            a = ["html", "css", "javascript", "java", "php", "python", "c", "c++", "c#", "xml", "ruby"],
                            b = '<div class="ui_editor_ul_wrap"><ul class="ui_editor_ul ui_editor_code">';
                ...
                date: {
                    name: "日期", click: function () {
                        var a = new Date, b = a.getFullYear(), d = ("0" + (a.getMonth() + 1)).slice(-2),
                ...
                preview: {
                    name: "预览", click: function () {
                        var a = window.screen,
                            b = window.open("", "Preview", "toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=" + Math.round(.9 * a.width) + ",height=" + Math.round(.8 * a.height) + ",left=" + Math.round(.05 * a.width)),
                            d = b.document;
                ...
                about: {
                    name: "关于", html: function () {
                        return '<div class="ui-editor-help"><strong>Sdcms富文本编辑器</strong><br><span>版本：</span>' + v + '<br><span>官网：</span><a href="https://www.sdcms.cn" target="_blacnk">Sdcms.Cn</a></div>'
                    }
                }
            }, c.btData = function (a) {
                ...
                var e = c.editor.find(".ui-editor-color-item"), f = c.editor.find(".ui-editor-color-self button"),
                    g = c.editor.find(".ui-editor-color-self input");
                e.hover(function () {
            ...
            if (c.fristToUp = function (a) {
                ...
                a.ajax({
                    ...
                    success: function (a) {
                        "success" == a.state ? (f(a, i), c.msg({
                            id: "#ui_editor_file_upload",
                            msg: "上传成功",
                            time: 5
                        })) : c.msg({id: "#ui_editor_file_upload", msg: a.msg, time: 5})
                    },
                    complete: function () {
                ...
                var e = b.index, f = c.upload || "", g = b.source || "", h = a(g).children(), i = c.params || {},
                    j = new FormData;
                j.append(c.file, c.fileList[e][0]);
                for (key in i) j.append(key, i[key]);
                a.ajax({
                    url: f + (-1 == f.indexOf("?") ? "?" : "&") + "action=all",
                    type: "post",
                    data: j,
                    contentType: !1,
                    processData: !1,
                ...
                var d = c.cmd, e = c.tool.find(".ui-editor-action-" + d).closest("a"), f = e.offset().left,
                    g = e.offset().top + e.outerHeight() - a(window).scrollTop(), h = document.body.clientWidth,
                    i = h - f - e.outerWidth();
                c.panel.css({
                    display: "block",
                    left: f + "px",
                    top: g + "px"
                }).html(b), f + c.panel.outerWidth() > h && i + c.panel.outerWidth() > h ? (f = (h - c.panel.outerWidth()) / 2, c.panel.css({
                    left: f + "px",
                    right: "auto"
                })) : f + c.panel.outerWidth() > h && i + c.panel.outerWidth() <= h && c.panel.css({
                    left: "auto",
                    right: i + "px"
                })
                ...
                var h, i, j, k, l, d = this, e = {title: "", text: "", width: "", height: "", type: 0},
                    f = a.extend({}, e, b), g = a('<div class="ui-editor-dialog-mask"></div>');
                ...
                if (c.tipsHide(), b.time = b.time || 3, b.tool = b.tool || !1, d = a(b.id), e = 0, f = 0, void 0 != d.css("display")) {
                    ...
                    d.hasClass("ui-editor-icon") && !c.isfullscreen && (e += 10), g.css({
                        left: e + "px",
                        top: f + "px",
                        position: "absolute"
                    }), b.time > 0 && (c.timer = setInterval(function () {
            ...
            G = '<div class="ui-editor-wrap" id="ui_editor_' + b + '">', G += '    <div class="ui-editor-tool" id="ui_editor_tool_' + b + '"><div class="ui-editor-tool-left">' + z + '</div><div class="ui-editor-tool-right">' + F + '</div><div class="ui-editor-panel" id="ui_editor_panel_' + b + '"></div></div>', G += '    <div class="ui-editor-html"><iframe id="ui_editor_iframe_' + b + '" height="' + c.height + 'px" frameborder="0" scrolling="auto"></iframe><div class="ui-editor-code"><textarea id="ui_editor_textarea_' + b + '" style="height:' + c.height + 'px;display:none;"></textarea></div></div>', G += '    <div class="ui-editor-dragBg" id="ui_editor_dragBg_' + b + '"></div><div class="ui-editor-drag" id="ui_editor_drag_' + b + '"><i class="ui-editor-icon-drag"></i></div>', G += "</div>", a(c).after(G), c.form = a(c).closest("form"), c.editor = a("#ui_editor_" + b), c.tool = a("#ui_editor_tool_" + b), c.panel = a("#ui_editor_panel_" + b), c.iframe = a("#ui_editor_iframe_" + b), c.textarea = a("#ui_editor_textarea_" + b), c.dragBg = a("#ui_editor_dragBg_" + b), c.drag = a("#ui_editor_drag_" + b), c.win = c.iframe[0].contentWindow, c.doc = c.win.document, c.doc.open(), c.doc.write(c.frameHtml(y)), c.doc.close(), h && (c.doc.body.contentEditable = "true"), c.doc.designMode = "On", c.autofocus && c.focus(), "code" == c.mode && (c.mode = "html", c.changeMode("code")), a(c.drag).bind("mousedown", function (b) {
                ...
                if (c.active(c.cmd, 0), c.hidePanel(), c.menu.left, a.each(c.button, function (a) {
                    ...
                    for (q += "  </div>", q += "</div>", m = '<div class="ui-editor-popup ui-editor-popup-table"><div class="ui-editor-popup-link">', p = [{
                        a: "addrow",
                        n: "插入行-上方",
                        c: "before",
                        i: "insertrowbefore",
                        o: ""
                    }, {a: "addrow", n: "插入行-下方", c: "after", i: "insertrowafter", o: ""}, {
                        a: "addcol",
                        n: "插入列-左侧",
                        c: "before",
                        i: "insertcolbefore",
                        o: ""
                    }, {a: "addcol", n: "插入列-右侧", c: "after", i: "insertcolafter", o: ""}, {
                        a: "delrow",
                        n: "删除行",
                        c: "row",
                        i: "delrow",
                        o: ""
                    }, {a: "delrow", n: "删除列", c: "col", i: "delcol", o: ""}, {
                        a: "deltable",
                        n: "删除表格",
                        c: "deltable",
                        i: "deltable",
                    ...
                    m += "</div></div>", a("body").append(m), h -= a(".ui-editor-popup").outerWidth() / 2, a(".ui-editor-popup").css({
                        left: h + "px",
                        top: j + "px",
                        display: "block"
                    })
                ...
                if (a(c.doc).find("table td").removeClass("ui-editor-selected"), e = b.target, f = l[e.tagName.toLowerCase()], f) {
                    if (c.removePop(), g = a(e).offset().left + c.iframe.offset().left, h = c.iframe.offset().top - a(window).scrollTop() + (a(e).offset().top - a(c.doc).scrollTop()), ("image" == f || "music" == f || "video" == f) && (c.isfullscreen && 10 >= g && (g = 0), h < c.iframe.offset().top - a(window).scrollTop() && (h = c.iframe.offset().top - a(window).scrollTop()), c.parent = a(e), c.parent.length > 0)) {
                        for (j = '<div class="ui-editor-popup ui-editor-popup-row"><div class="ui-editor-popup-link">', k = [{
                            a: "edit",
                            n: "修改",
                            c: f,
                            i: "editlink"
                        }, {a: "align", n: "左对齐", c: "left", i: "left"}, {
                            a: "align",
                            n: "右对齐",
                            c: "right",
                            i: "right"
                        }, {a: "align", n: "取消对齐", c: "delete", i: "canel"}, {
                            a: "del",
                            n: "删除",
                            c: "",
                            i: "delete"
                        ...
                        j += "</div></div>", a("body").append(j), g = g - a(".ui-editor-popup").outerWidth() - 15, c.isfullscreen && g <= a(".ui-editor-popup").outerWidth() && (g = 0), a(".ui-editor-popup").css({
                            left: g + "px",
                            top: h + "px",
                            display: "block"
                        })
                ...
                var b = a(this).data("that"), c = a(this).data("type"), d = a("#" + b)[0], e = a(this).data("cmd"),
                    f = a(d.parent).closest(e);
                ...
                var b, c, d;
                a(this).hasClass("ui-editor-disabled") || (b = a(this).data("align") || "", c = a(this).data("that"), d = a("#" + c)[0], b = "" == b ? "top" : b, "" != a(this).data("title") && (d.isfullscreen && "top" == b && a(this).hasClass("ui-editor-icon") && (b = "bottom"), d.tipsShow({
                    text: a(this).data("title"),
                    id: this,
                    align: b
                })))
